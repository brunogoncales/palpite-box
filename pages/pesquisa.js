  ...
  return (
    <div className='pt-6'>
     <PageTitle title = 'Pesquisa' />
      ...
      <p className='text-center mb-6'>O restaurante X sempre busca atender melhor seus clientes.<br />
  ...
  { sucess && <div className='w-1/5 mx-auto'>
   ...
   }
   {
     retorno.showCoupon && <div className='text-center border p-4 mb-4'>
      ...
      <br /> 
      <span className='italic'>Tire um print ou foto deta tela e apresente ao garçon.</span>
      </div>
}
    </div>}
</div>
